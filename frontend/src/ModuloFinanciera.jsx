              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50 text-slate-500 text-xs uppercase tracking-wider border-b border-slate-200">
                    <th className="px-3 py-2 font-bold w-[5cm] min-w-[5cm] max-w-[5cm]">Folio</th>
                  ...
                  {pepsFiltrados.length > 0 ? (
                    pepsFiltrados.map((pep) => (
                      <tr key={pep.id} className="hover:bg-slate-50 transition-colors">
                        <td className="px-3 py-2 text-xs font-semibold text-slate-700 whitespace-nowrap w-[5cm] min-w-[5cm] max-w-[5cm] overflow-hidden text-ellipsis">{pep.folio}</td>
